...
gym.register(
    id="Isaac-Stack-Cube-Franka-IK-Abs-DiffusionPolicy-RGB-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": stack_ik_abs_env_cfg.FrankaCubeStackEnvCfgRGB,
        "robomimic_diffusion_policy_cfg_entry_point": os.path.join(agents.__path__[0], "robomimic/bc_DiffusionPolicy_low_dim_RGB.json"),
    },
    disable_env_checker=True,
)
